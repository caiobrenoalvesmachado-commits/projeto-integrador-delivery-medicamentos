...
3. *Taxa de Cobertura de Demanda por Hotspot:* Mede a proporção de pedidos totais que são atendidos dentro do raio de cobertura imediata dos três centroides identificados pelo K-Means, em relação ao total de pedidos da base. Com base na simulação realizada, 100% dos 300 pedidos analisados (120 em Jardim da Penha, 90 em Praia do Canto/Enseada do Suá e 90 em Bento Ferreira/Santa Lúcia) estão contidos dentro dos três hotspots identificados, o que indica que o posicionamento estratégico do entregador nesses três pontos é suficiente, neste cenário, para cobrir a totalidade da demanda da região mapeada. Esse indicador é fundamental para validar a escalabilidade do modelo: com isso a métrica permitirá identificar se a cobertura permanece alta ou se há demanda dispersa fora dos hotspots, sinalizando a necessidade de novos centroides

## Link do Vídeo de apresentação do projeto:
https://youtu.be/b2RpriCMg0k
